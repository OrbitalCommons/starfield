...
//!
//! [`starfield-planet-spectra`]: https://docs.rs/starfield-surfaces/latest/starfield_surfaces/planet_spectra
//! [`starfield-reflectance-library`]: https://docs.rs/starfield-surfaces/latest/starfield_surfaces/reflectance_library
