...
use starfield_core::data::source_utils::artifact::materialize;
use starfield_core::data::source_utils::datastore::{
    Artifact, ArtifactKey, ContentCheck, Datastore, DatastoreBuilder, Source,
};
use starfield_core::data::source_utils::{adopt_legacy, cache_dir, datastore_error};
...
impl<R: GaiaRelease> Downloader<R> {
    ...
    /// the artifact. Use with [`CsvSourceReader::from_reader`](crate::gaia::common::reader::CsvSourceReader::from_reader).
    /// Caller is
