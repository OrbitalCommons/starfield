...
//! into [`crate::gaia::common::reader::CsvSourceReader::from_reader`] without any
//! schema massaging.
//!
//! # Example
//!
//! ```no_run
//! use starfield_catalogs::gaia::Dr3;
...
use crate::gaia::common::traits::GaiaRelease;
...
impl<R: GaiaRelease> Downloader<R> {
    ...
    /// [`CsvSourceReader::from_reader`](crate::gaia::common::reader::CsvSourceReader::from_reader)
