...
use crate::gaia::common::core::GaiaCore;
use crate::gaia::common::traits::{GaiaSource, Release};
...
/// catalog — load them with [`load_tgas_block_map`](crate::gaia::dr1::catalog::load_tgas_block_map)
/// and splice in with [`Dr1Catalog::attach_tgas`](crate::gaia::dr1::catalog::Dr1Catalog::attach_tgas).
