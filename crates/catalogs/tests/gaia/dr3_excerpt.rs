...
use starfield_catalogs::gaia::{Dr3, Dr3Catalog};
...
fn id_range_shard_buckets_monotonically() {
    ...
    use starfield_catalogs::gaia::common::core::GaiaCore;
    use starfield_catalogs::gaia::dr3::Dr3Entry;
...
fn excerpt_from_reader_streams_without_disk() {
    ...
    use starfield_catalogs::gaia::excerpt::excerpt_csv_reader;
    use std::io::Cursor;
