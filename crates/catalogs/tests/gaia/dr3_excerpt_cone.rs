...
use starfield_catalogs::gaia::excerpt::{excerpt_csv_file, HashIdShard, HealpixShard};
use starfield_catalogs::gaia::{
...
fn empty_lazy_dir_is_empty() {
    ...
    use starfield_catalogs::gaia::excerpt::ShardedCsvWriter;
