...
//!
//! ```sh
//! cargo test -p starfield-catalogs --features mast --test mast_network -- --ignored --nocapture
//! ```
//!
...
use starfield_catalogs::mast::{MastClient, Wcs};
use starfield_core::data::source_utils::datastore::Datastore;
