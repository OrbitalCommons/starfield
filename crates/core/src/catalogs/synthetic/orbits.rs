...
//! use starfield_core::catalogs::synthetic::orbits::SyntheticOrbitPopulation;
//!
...
///
/// Follows the JPL SBDB conventions used by JPL SBDB orbital elements:
...
impl SyntheticOrbit {
    ...
    /// use rand::SeedableRng;
    /// use starfield_core::catalogs::synthetic::orbits::SyntheticOrbitPopulation;
    /// use starfield_core::constants::GM_SUN;
...
/// use rand::rngs::StdRng;
/// use rand::SeedableRng;
/// use starfield_core::catalogs::synthetic::orbits::{InclinationModel, SyntheticOrbitPopulation};
///
