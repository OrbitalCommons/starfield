...
//!
//! ```
//! use starfield_core::constants::{AU_KM, DAY_S, GM_SUN};
//! use starfield_core::secularlib::GM_SUN_AU3_DAY2;
//!
...
/// Agrees with `starfield_core::constants::GM_SUN` (km³/s², from a slightly older
