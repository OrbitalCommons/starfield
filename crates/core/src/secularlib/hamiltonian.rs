...
///
/// ```
/// use starfield_core::secularlib::{quadrupole_hamiltonian, GM_NEPTUNE_AU3_DAY2};
///
...
///
/// ```
/// use starfield_core::secularlib::{coplanar_quadrupole, GM_NEPTUNE_AU3_DAY2};
///
...
///
/// ```
/// use starfield_core::secularlib::{numerical_secular_hamiltonian, GM_NEPTUNE_AU3_DAY2};
///
...
///
/// ```
/// use starfield_core::secularlib::{phase_portrait, GM_NEPTUNE_AU3_DAY2};
///
