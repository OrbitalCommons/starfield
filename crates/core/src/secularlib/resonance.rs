...
///
/// ```
/// use starfield_core::secularlib::{resonance_semi_major_axis, A_NEPTUNE_AU};
///
...
///
/// ```
/// use starfield_core::secularlib::resonant_angle;
///
...
///
/// ```
/// use starfield_core::secularlib::libration_amplitude;
///
...
///
/// ```
/// use starfield_core::secularlib::critical_perihelion_neptune;
///
