...
///
/// ```
/// use starfield_core::magnitudelib::small_body::{mass_radius_neptunian, NEPTUNE_RADIUS_EARTH};
///
...
///
/// ```
/// use starfield_core::magnitudelib::small_body::absolute_magnitude;
///
...
///
/// ```
/// use starfield_core::magnitudelib::small_body::apparent_magnitude;
///
...
///
/// ```
/// use starfield_core::magnitudelib::small_body::hg_phase_factor;
///
...
///
/// ```
/// use starfield_core::magnitudelib::small_body::phase_integral;
///
...
///
/// ```
/// use starfield_core::magnitudelib::small_body::apparent_magnitude_with_phase;
///
...
///
/// ```
/// use starfield_core::magnitudelib::small_body::phase_angle;
///
...
///
/// ```
/// use starfield_core::magnitudelib::small_body::opposition_delta;
///
...
///
/// ```
/// use starfield_core::magnitudelib::small_body::planet_apparent_magnitude;
///
