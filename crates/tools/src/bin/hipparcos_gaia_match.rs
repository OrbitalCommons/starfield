...
use starfield_catalogs::gaia::common::reader::CsvSourceReader;
use starfield_catalogs::gaia::download::Downloader;
use starfield_catalogs::gaia::{Dr1, Dr2, Dr3, GaiaRelease, GaiaSource};
use starfield_catalogs::hipparcos::{download_hipparcos, HipparcosCatalog};
use starfield_core::catalogs::StarCatalog;
use starfield_core::data::source_utils::cache_dir;
...
fn bp_rp_of<R: GaiaRelease>(_entry: &R::Entry) -> (f64, f64, f64) {
    ...
    if let Some(e) = any.downcast_ref::<starfield_catalogs::gaia::Dr3Entry>() {
    ...
    if let Some(e) = any.downcast_ref::<starfield_catalogs::gaia::Dr2Entry>() {
        return match e.bp_rp.as_ref() {
            Some(b) => (
                b.phot_bp_mean_mag.unwrap_or(f64::NAN),
                b.phot_rp_mean_mag.unwrap_or(f64::NAN),
