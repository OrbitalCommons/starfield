...
//! Run with: `cargo test -p starfield-jpl --features rubin --test rubin_url_verification -- --ignored`
//!
...
use starfield_core::data::source_utils::{check_endpoint_status, EndpointStatus};
use starfield_jpl::rubin::*;
